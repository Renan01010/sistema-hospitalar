...
int main()
{
    ...
    { // menu
        ...
        printf("3. Atender próximo paciente com maior prioridade\n");
        ...
        printf("7. Total de pacientes por nível de risco (1 a 5)\n");
        printf("0. Sair\n");
    ...
    //         scanf("%d", &id);
    //         atribuirPrioridade(&pacientes, id);
    //     case 3: // Visualizar fila de espera
    //         exibir(&pacientes);
    //         break;
    //     case 4: // Relatorio de atendimento
    //         atendimentoPrioridade(&pacientes);
    //         tempoMedio(&pacientes);
    //         break;
    //     case 5: // Tempo medio atendimento
    //         printf("Digite o nivel de prioridade (1-5) para calcular o tempo medio: \n");
    //         scanf("%d", &nivel);
    //         grtchar();
    //         tempoMedio(&pacientes2, nivel);
    //         break;
    //     case 6: // Total de pacientes por nivel de risco
    //         pacientesPorNivel(&pacientes2);
    //         break;
    //     case 0: // Sair
    //         printf("Voce escolheu sair!\n");
